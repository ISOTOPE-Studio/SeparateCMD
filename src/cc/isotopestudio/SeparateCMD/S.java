...
public class S {
    ...
    public static String toPrefixRed(String s) {
        return SeparateCMDtm.prefix + ChatColor.RED + s + ChatColor.RESET;
    }

    public static String toPrefixGreen(String s) {
        return SeparateCMDtm.prefix + ChatColor.GREEN + s + ChatColor.RESET;
    }

    public static String toPrefixYellow(String s) {
        return SeparateCMDtm.prefix + ChatColor.YELLOW + s + ChatColor.RESET;
    }

    public static String toPrefixGray(String s) {
        return SeparateCMDtm.prefix + ChatColor.GRAY + s + ChatColor.RESET;
    }
    ...
    public static String toPrefixAqua(String s) {
        return SeparateCMDtm.prefix + ChatColor.AQUA + s + ChatColor.RESET;
    }
}
